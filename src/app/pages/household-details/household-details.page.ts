...
@Component({
  ...
  templateUrl: './household-details.page.html',
  styleUrls: ['./household-details.page.scss'],
})
export class HouseholdDetailsPage implements OnInit {
  ...
  editHousehold() {
    this.navCtrl.navigateBack(['/edit-household', this.id]);
  }
